...
import 'package:bank_ui/pages/auth/login/login_face_unlock_page.dart';
import 'package:bank_ui/pages/auth/login/pin_code_page.dart';
import 'package:bank_ui/pages/auth/register/register_fingerprint_unlock_page.dart';
import 'package:bank_ui/pages/auth/register/register_page.dart';
import 'package:bank_ui/pages/card/add_card_page.dart';
import 'package:bank_ui/pages/dashboard/add_new_account/add_new_account_page.dart';
import 'package:bank_ui/pages/dashboard/saving/add_saving_page.dart';
import 'package:bank_ui/pages/dashboard/saving/saving_page.dart';
import 'package:bank_ui/pages/dashboard/transfer/transfer_bank_page.dart';
import 'package:bank_ui/pages/dashboard/transfer/transfer_page.dart';
import 'package:bank_ui/pages/dashboard/transfer/transfer_successful_page.dart';
import 'package:bank_ui/pages/dashboard/transfer/transfer_to_friends_page.dart';
import 'package:bank_ui/pages/dashboard/withdraw/withdraw_code_page.dart';
import 'package:bank_ui/pages/dashboard/withdraw/withdraw_page.dart';
import 'package:bank_ui/pages/onboard/onbording_page.dart';
import 'package:bank_ui/pages/profile/security_page.dart';
import 'package:bank_ui/pages/scan/scan_page.dart';
import 'package:bank_ui/pages/splash/splash_page.dart';
